...
const steps = [
  { id: 1, title: 'Account Type', subtitle: 'Choose how you want to use Side Bud' },
      ...
      <div className="relative w-full max-w-md m-auto">
        <AnimatedPage>
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-surface-500 dark:text-surface-400 text-sm">Join the Side Bud community</p>
          </div>
