            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-xl bg-surface-50 dark:bg-surface-800/50 max-h-60 overflow-y-auto">
                <div className="space-y-3 text-sm text-surface-600 dark:text-surface-400">
                  <p>By becoming a Nabri Partner, you agree to:</p>
                  <ul className="list-disc list-inside space-y-1 ml-2">
                    ...
                    <li>Comply with Nabri's partner code of conduct</li>
                  </ul>
                  <p className="mt-4">Nabri reserves the right to suspend partners who violate these terms.</p>
                </div>
              </div>
