      ...
      <AnimatedPage>
        <GlassCard variant="elevated" padding="lg" className="prose prose-sm dark:prose-invert max-w-none">
          ...
          <div className="space-y-6 text-sm text-surface-600 dark:text-surface-400 leading-relaxed">
            <section><h2 className="text-lg font-semibold text-surface-900 dark:text-white">1. Acceptance of Terms</h2><p>By accessing or using Side Bud ("the App"), you agree to be bound by these Terms & Conditions. If you do not agree, do not use the App.</p></section>
            ...
            <section><h2 className="text-lg font-semibold text-surface-900 dark:text-white">5. Walking Partner Services</h2><p>Walking Partner services are provided by independent individuals. Side Bud facilitates connections but is not a party to any agreement between users and walking partners. Users should exercise caution and use the OTP verification system for safety.</p></section>
            ...
            <section><h2 className="text-lg font-semibold text-surface-900 dark:text-white">7. Privacy</h2><p>Your use of Side Bud is also governed by our Privacy Policy. Please review it to understand our practices regarding your personal data.</p></section>
            <section><h2 className="text-lg font-semibold text-surface-900 dark:text-white">8. Intellectual Property</h2><p>All content, trademarks, and intellectual property on Side Bud are owned by or licensed to us. You may not reproduce, distribute, or create derivative works without our written consent.</p></section>
            <section><h2 className="text-lg font-semibold text-surface-900 dark:text-white">9. Limitation of Liability</h2><p>Side Bud is provided "as is" without warranties of any kind. We are not liable for any indirect, incidental, special, or consequential damages arising from your use of the App.</p></section>
      ...
      <AnimatedPage>
        <GlassCard variant="elevated" padding="lg" className="prose prose-sm dark:prose-invert max-w-none">
          ...
          <div className="space-y-6 text-sm text-surface-600 dark:text-surface-400 leading-relaxed">
            ...
            <section><h2 className="text-lg font-semibold text-surface-900 dark:text-white">7. Children's Privacy</h2><p>Side Bud is not intended for users under 18 years of age. We do not knowingly collect information from children under 18.</p></section>
      ...
      <AnimatedPage>
        <GlassCard variant="elevated" padding="lg">
          ...
          <div className="space-y-6 text-sm text-surface-600 dark:text-surface-400 leading-relaxed">
            ...
            <section><h2 className="text-lg font-semibold text-surface-900 dark:text-white">No Illegal Activity</h2><p>Side Bud must not be used for any illegal activities including but not limited to: theft, fraud, drug use, violence, or any activity that violates Indian law.</p></section>
