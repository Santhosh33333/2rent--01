      ...
      <AnimatedPage>
        <GlassCard variant="elevated" padding="lg" className="prose prose-sm dark:prose-invert max-w-none">
          ...
          <div className="space-y-6 text-sm text-surface-600 dark:text-surface-400 leading-relaxed">
            <section><h2 className="text-lg font-semibold text-surface-900 dark:text-white">1. Acceptance of Terms</h2><p>By accessing or using Nabri ("the App"), you agree to be bound by these Terms &amp; Conditions. If you do not agree, do not use the App.</p></section>
            <section><h2 className="text-lg font-semibold text-surface-900 dark:text-white">2. Eligibility</h2><p>You must be at least 18 years old to use Nabri. By using the App, you represent that you meet this age requirement and have the legal capacity to enter into these Terms.</p></section>
      ...
      <AnimatedPage>
        <GlassCard variant="elevated" padding="lg">
          ...
          <div className="space-y-6 text-sm text-surface-600 dark:text-surface-400 leading-relaxed">
            ...
            <section><h2 className="text-lg font-semibold text-surface-900 dark:text-white">No Illegal Activity</h2><p>Nabri must not be used for any illegal activities including but not limited to: theft, fraud, drug use, violence, or any activity that violates Indian law.</p></section>
