  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow': '0 2px 10px rgba(216, 61, 39, 0.12)',
        'glow-lg': '0 4px 16px rgba(216, 61, 39, 0.18)',
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, hsla(11, 85%, 60%, 0.12) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(76, 90%, 62%, 0.12) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(34, 50%, 85%, 0.2) 0px, transparent 50%)',
      },
    },
  },
  plugins: [],
