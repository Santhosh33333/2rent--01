  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow': '0 2px 10px rgba(18, 49, 111, 0.12)',
        'glow-lg': '0 4px 16px rgba(18, 49, 111, 0.18)',
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, hsla(220, 84%, 44%, 0.12) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(76, 90%, 62%, 0.12) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(34, 50%, 85%, 0.2) 0px, transparent 50%)',
      },
    },
  },
  plugins: [],
